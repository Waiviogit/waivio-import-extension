...
export const PERSON_FORM_FIELDS: FormFieldConfig[] = [
  ...
  { label: 'Facebook', name: ['socialLinks', 'linkFacebook'] },
  { label: 'Twitter', name: ['socialLinks', 'linkTwitter'] },
  { label: 'YouTube', name: ['socialLinks', 'linkYouTube'] },
  { label: 'TikTok', name: ['socialLinks', 'linkTikTok'] },
  { label: 'Reddit', name: ['socialLinks', 'linkReddit'] },
  { label: 'LinkedIn', name: ['socialLinks', 'linkLinkedIn'] },
  { label: 'Telegram', name: ['socialLinks', 'linkTelegram'] },
  { label: 'WhatsApp', name: ['socialLinks', 'linkWhatsApp'] },
  { label: 'Pinterest', name: ['socialLinks', 'linkPinterest'] },
  { label: 'Twitch', name: ['socialLinks', 'linkTwitch'] },
  { label: 'Snapchat', name: ['socialLinks', 'linkSnapchat'] },
  { label: 'Instagram', name: ['socialLinks', 'linkInstagram'] },
  { label: 'GitHub', name: ['socialLinks', 'linkGitHub'] },
  { label: 'Hive', name: ['socialLinks', 'linkHive'] },
  { label: 'Price amount', name: 'mostRecentPriceAmount' },
  { label: 'Price currency', name: 'mostRecentPriceCurrency' },
  {
    label: 'Product IDs',
